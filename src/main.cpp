...
const string strMessageMagic = "Dreamcoin Signed Message:\n";
...
const int DAILY_BLOCKCOUNT =  1440 / 5;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Dreamcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "DreamCoin -  Third Time's The Charm";
        CTransaction txNew;
        if (!fTestNet)
        {
            txNew.nTime = 1445269900;
        }
        else
        {
            txNew.nTime    = 1445269820; // Without separate txNew.nTime near block.nTime, CheckBlock fails on coinbase timestamp for TestNet created on 14042015
        }
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1445269920;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3050552;
        if (fTestNet)
        {
            block.nTime    = 0;
            block.nNonce   = 0;
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0x2127a61b68f6eadf044da0f13518ad9165b8888a64f0f1d50ec2b37c6395b6cf"));
        block.print();
